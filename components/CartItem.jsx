      ...
      <div className="grid col-span-2 md:col-span-3 xl:col-span-1 grid-cols-2 gap-2 md:gap-4">
        ...
        <div className="pt-4">
          ...
          <div className="mt-4 flex gap-2">
            ...
            <button className="text-red-500 underline cursor-pointer hover:text-red-600" onClick={deleteItem}>
              Remove
            </button>
          </div>
        </div>
      ...
      <div className="h-center">
        <div className="flex md:block flex-col justify-between items-end">
          ...
          <div className="px-4 py-2 rounded-lg border-2 border-primary v-center gap-3 md:hidden">
            <span className="bg-gray-400 hv-center h-5 w-5 cursor-pointer rounded-full" onClick={handleRemoveFromCart}>
              <FaMinus className="text-white text-[10px]" />
            </span>
            <span className="text-gray-400 font-medium text-sm">{qty}</span>
            <span className="bg-primary hv-center h-5 w-5 cursor-pointer rounded-full" onClick={handleAddToCart}>
