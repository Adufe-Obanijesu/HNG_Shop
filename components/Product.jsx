    ...
    <Link href={`/products/${product?.id}`}>
      <div className="space-y-2 hover:scale-[1.02] hover:border-b-2 pb-2 transition-item">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm tracking-wide">{product?.description}</p>
        </div>
        ...
        <div className="flex justify-between">
          <div className="v-center">
            ...
            <span className="font-bold md:text-lg">{formatNumberWithCommas(Number(product?.current_price[0].NGN[0]))}</span>
          </div>
