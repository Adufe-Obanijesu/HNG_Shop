...
export default function Home({ products }) {
  return (
    <main>
            ...
            <div className="text-center py-8 text-white space-y-6">
              <div className="space-y-">
                ...
                <object
                  ...
                  data="/svgs/SALES.svg"
                  height="118"
                  className="xl:w-[355px] xl:h-[118px] md:w-[250px] md:h-[90px] w-[175px] h-[90px] mx-auto xl:mx-0 -mt-6 md:mt-0"
                >
          ...
          <div className="grow space-y-3 hv-center flex-col">
            <div className="h-center">
              <object
                type="image/svg+xml"
                data="/svgs/NEW.svg"
                className="xl:w-[160px] xl:h-[47px] md:w-[110px] md:h-[35px] w-[70px] h-[25px]"
              >
                Your browser does not support SVG
              </object>
            </div>
            <h1 className="font-semibold text-center xl:text-6xl md:text-4xl text-3xl">
              ARRIVAL
            </h1>
            <div className="h-center">
              <Link href="/products">
      ...
      <section className="">
        <h3 className="font-bold md:text-3xl text-2xl mb-6">
          Popular Products
        </h3>
