                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="v-center gap-4">
                        <div className="bg-gray-100 rounded-lg hv-center px-4 py-2 gap-4">
                            ...
                            <input type="text" placeholder="Search for Products" className="bg-transparent focus:outline-none text-gray-700" />
                        </div>
                        ...
                        categories.map(category => {
                            ...
                            return (
                                <div key={name+img} className="border px-4 py-2 space-y-2">
                                    <Image src={`/img/categories/${img}`} alt={name} width={1000} height={1000} className="w-20 h-20 rounded-full" />
