            ...
            <section>
                <div className="flex gap-4">
                    <div className="flex flex-col justify-between shrink-0">
                        <Image src="/img/product/1.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/2.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/3.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/4.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/5.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/6.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/7.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                        <Image src="/img/product/8.png" alt="dress" width={1000} height={1000} className="w-16 h-14 object-cover" />
                    </div>

                    <div className="grid grid-cols-2 gap-8">
                        <div>
                            <div className="h-full w-full relative">
                                <Image src="/img/corporate_lady.png" fill alt="corporate dress" className="h-full w-full object-cover object-top" />
                            </div>
                        </div>
                        ...
                        <div className="py-8">
                            ...
                            <div className="mt-4">
                                ...
                                <p className="text-gray-600 mt-2">
                                    Classic women&apos;s tailored suit from Arries place. Single breasted design, notch lapel, two button closure, tailored fit for a flattering silhouette.
                                </p>
                            </div>
