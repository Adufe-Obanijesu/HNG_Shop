            ...
            <section className="border-b pb-8 mt-8">
                ...
                <div>
                    <div className="grid grid-cols-4">
                        <h4 className="border-b pb-3 text-gray-600 font-medium">
                            Product
                        </h4>
...

                    {
                        checkout.map(item => {
                            ...
                            return <CheckoutItem key={name+price} name={name} color={color} size={size} price={price} qty={qty} img={img} />
                        })
                    }
                    ...
                    <div className="flex justify-end">
                        <div>
                            <div className="rounded-lg p-4 bg-blue-100 space-y-4">
                                ...
                                <div className="flex">
                                    <div className="btn btn-white w-auto">
                                        Card
                                    </div>
                                </div>

                                <div className="flex gap-8">
                                    <Image src="/img/card.png" alt="card" width={1000} height={1000} className="w-full h-auto" />
